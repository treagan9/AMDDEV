        ...
        <MotionBox initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          <Flex direction={{ base: 'column', lg: 'row' }} alignItems={{ base: 'stretch', lg: 'center' }} justifyContent="space-between" gap={{ base: 10, lg: 16 }}>
            <Box maxW={{ base: '100%', lg: '580px' }}>
              <Text fontSize="xs" fontWeight={600} letterSpacing="2px" textTransform="uppercase" color="brand.champagne" mb={5}>Let's talk</Text>
              <Text as="h2" fontFamily="heading" fontSize={{ base: '3xl', md: '4xl', lg: '5xl' }} fontWeight={700} color="brand.slate" lineHeight={1.08} mb={4}>Build a program for your team</Text>
              <Text fontSize="md" color="brand.body" lineHeight={1.8} mb={6}>Every organization is different. We'll work with you to create a corporate health program that fits your people and your budget.</Text>
              <ChakraLink href="mailto:corporate@answersmd.com" fontSize="md" color="brand.champagne" fontWeight={500} _hover={{ color: 'brand.champagneDark' }}>corporate@answersmd.com</ChakraLink>
            </Box>
