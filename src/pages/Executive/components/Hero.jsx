  ...
  return (
    ...
    >
      ...
      <Box
        ...
        right={0}
        bottom={0}
        bg="linear-gradient(to bottom, rgba(250,250,247,0.88) 0%, rgba(250,250,247,0.85) 40%, rgba(250,250,247,0.38) 62%, transparent 80%)"
        zIndex={1}
      />
      ...
      >
        <VStack spacing={7} align={{ base: 'center', md: 'flex-start' }} maxW={{ md: '620px', lg: '680px' }} position="relative">
          ...
          <MotionBox initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.25 }}>
            <Text as="h1" fontFamily="heading" fontSize={{ base: '4xl', md: '5xl', lg: '6xl' }} fontWeight={700} color="brand.slate" lineHeight={1.05}>Protect your most</Text>
            <Text fontFamily="heading" fontSize={{ base: '4xl', md: '5xl', lg: '6xl' }} fontWeight={700} color="brand.champagne" lineHeight={1.05}>valuable asset.</Text>
          </MotionBox>

          <MotionText fontSize={{ base: 'md', md: 'lg' }} color="brand.body" lineHeight={1.8} maxW={{ base: '520px', md: '460px' }} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }}>
            Your executives and key employees drive your business. Their health should never wait weeks for care or get lost in a system that was not built for how they live.
          </MotionText>
