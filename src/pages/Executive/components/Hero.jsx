...
function Hero() {
  return (
    <Box pt={{ base: 32, md: 40 }} pb={{ base: 'sectionMobile', md: '160px' }} bg="brand.evergreen">
      <Box maxW="98%" mx="auto" px={{ base: 6, md: 4 }}>
        <MotionBox initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} maxW="800px">
          ...
          <Text as="h1" fontFamily="heading" fontSize={{ base: '3xl', md: '5xl', lg: '6xl' }} fontWeight={700} color="white" lineHeight={1.08} mb={6}>Protect your most valuable asset</Text>
          <MotionText fontSize={{ base: 'md', md: 'lg' }} color="whiteAlpha.600" lineHeight={1.8} maxW="600px" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
