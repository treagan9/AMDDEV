// src/pages/Insurance/components/CTA.jsx
import {
  Box,
  Flex,
  VStack,
        ...
        <MotionBox initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          <Flex direction={{ base: 'column', lg: 'row' }} alignItems={{ base: 'stretch', lg: 'center' }} justifyContent="space-between" gap={{ base: 10, lg: 16 }}>
            <Box maxW={{ base: '100%', lg: '580px' }}>
              <Text fontSize="xs" fontWeight={600} letterSpacing="2px" textTransform="uppercase" color="brand.champagne" mb={5}>Questions about coverage?</Text>
              <Text as="h2" fontFamily="heading" fontSize={{ base: '3xl', md: '4xl', lg: '5xl' }} fontWeight={700} color="white" lineHeight={1.08} mb={4}>We'll walk you through it</Text>
              <Text fontSize="md" color="whiteAlpha.600" lineHeight={1.8}>Happy to discuss how membership works with your specific insurance situation.</Text>
            </Box>
            <VStack spacing={4} align={{ base: 'stretch', lg: 'stretch' }} w={{ base: '100%', lg: 'auto' }} flexShrink={0}>
              <Button as={Link} to="/contact/" bg="white" color="brand.evergreen" borderRadius="btn" size="lg" fontSize="md" _hover={{ bg: 'brand.ivory', transform: 'translateY(-2px)', shadow: '0 8px 24px rgba(0,0,0,0.2)' }} transition="all 0.3s ease">Get in touch</Button>
