          ...
          <Box position="relative" borderRadius={{ base: '24px', md: '32px' }} overflow="hidden">
            ...
            <Box position="relative" zIndex={2} py={{ base: 12, md: 16 }} px={{ base: 8, md: 16 }}>
              <Flex direction={{ base: 'column', lg: 'row' }} alignItems={{ base: 'stretch', lg: 'center' }} justifyContent="space-between" gap={{ base: 8, lg: 12 }}>
                <Box flex={1}>
                  <Text fontSize="xs" fontWeight={600} letterSpacing="2px" textTransform="uppercase" color="brand.champagne" mb={4}>Questions about coverage?</Text>
                  <Text as="h2" fontFamily="heading" fontSize={{ base: '2xl', md: '3xl', lg: '4xl' }} fontWeight={700} color="brand.slate" lineHeight={1.12} mb={3}>We'll walk you through it</Text>
                  <Text fontSize="md" color="brand.body" lineHeight={1.8}>Happy to discuss how membership works with your specific insurance situation.</Text>
                </Box>
