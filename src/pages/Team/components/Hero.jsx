...
var HERO = {
  ...
  headingAccent: 'not time limits.',
  body: 'Our physicians chose concierge medicine to practice the way they always envisioned, with the time and attention your health deserves.',
      ...
      <Box display={{ base: 'none', md: 'block' }} position="relative" minH={{ md: '92vh', lg: '100vh' }} overflow="hidden">
        <Box position="absolute" top={0} left={0} right={0} bottom={0} zIndex={0}>
          <picture>
            ...
            <img src="/home/our-team-hero-desktop.webp" alt="AnswersMD concierge medicine care team" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
          </picture>
        </Box>
        ...
        <MotionBox initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          <Box position="relative" overflow="hidden">
            <Box sx={{ aspectRatio: '3 / 4' }}>
              <img src="/home/our-team-hero-ipad.webp" alt="AnswersMD care team" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 25%' }} />
            </Box>
