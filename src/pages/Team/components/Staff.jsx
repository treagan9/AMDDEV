...
var STAFF = [
  { name: 'Lauren Shapiro', role: 'Chief of Staff', photo: '/team/lauren-shapiro.webp', description: 'Lauren brings structure and heart to everything behind the scenes. She coordinates physician schedules, manages clinical workflows and ensures every operational detail aligns with the personalized care model our members expect.' },
  ...
  { name: 'Laura Gore', role: 'Nurse Manager', photo: '/team/laura-gore.webp', description: 'Laura leads the clinical side of every patient visit from rooming and vitals to in-office procedures and follow-up coordination. Her clinical experience and calm presence make her a steady anchor of the care team.' },
  { name: 'Sarah Juarez', role: 'Medical Assistant', photo: '/team/sarah-juarez.webp', description: 'Sarah supports our physicians and nursing team across every part of the visit. She brings a friendly, attentive presence that helps every patient feel comfortable and heard.' }
];
