// src/pages/Team/components/CTA.jsx
import {
  Box,
  Flex,
  VStack,
        ...
        <MotionBox initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          <Flex direction={{ base: 'column', lg: 'row' }} alignItems={{ base: 'stretch', lg: 'center' }} justifyContent="space-between" gap={{ base: 10, lg: 16 }}>
            <Box maxW={{ base: '100%', lg: '580px' }}>
              ...
              <Text as="h2" fontFamily="heading" fontSize={{ base: '3xl', md: '4xl', lg: '5xl' }} fontWeight={700} color="white" lineHeight={1.08} mb={4}>Ready to meet your care team?</Text>
              <Text fontSize="md" color="whiteAlpha.600" lineHeight={1.8}>Schedule a consultation to learn how AnswersMD can transform your healthcare experience.</Text>
            </Box>
