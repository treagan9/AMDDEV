  ...
  return (
    ...
    >
      <Box position="absolute" top={0} left={0} right={0} bottom={0} zIndex={0}>
        <picture>
          <source media="(max-width: 767px)" srcSet="/new-patients/hero-mobile.png" />
          <source media="(max-width: 991px)" srcSet="/new-patients/hero-tablet.png" />
          <img
            src="/new-patients/hero-desktop.png"
            alt="AnswersMD new patient experience"
      ...
      <Box maxW="960px" mx="auto" px={{ base: 6, md: 4 }} textAlign="center" position="relative" zIndex={2}>
        <VStack spacing={7}>
          ...
          <MotionText fontSize={{ base: 'md', md: 'lg' }} color="brand.body" lineHeight={1.8} maxW="520px" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }}>
            Your guide to joining AnswersMD. From your first consultation to comprehensive care.
          </MotionText>
        </VStack>
      </Box>
    </Box>
