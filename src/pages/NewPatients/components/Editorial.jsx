      ...
      <Box maxW={{ base: '98%', lg: '60%' }} mx="auto" px={{ base: 6, md: 4 }}>
        <MotionBox initial={{ opacity: 0, y: 24 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <Box borderLeft="3px solid" borderColor="brand.champagne" pl={{ base: 6, md: 10 }} py={2}>
            <Text fontSize={{ base: 'lg', md: 'xl' }} color="brand.slate" fontFamily="heading" fontWeight={700} fontStyle="italic" lineHeight={1.6} mb={4}>
            ...
            <Text fontSize="md" fontWeight={600} color="brand.slate">Dr. Douglas Shapiro</Text>
            <Text fontSize="md" color="brand.bodyLight">Founder</Text>
          </Box>
        </MotionBox>
      </Box>
    </Box>
