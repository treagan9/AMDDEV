// src/pages/Locations/BocaRaton/components/CoverageMap.jsx
...
var LAT = 26.3415;
var LNG = -80.0839;
var COVERAGE_RADIUS_KM = 10;
var AREA_QUERY = '1801 S Federal Hwy Boca Raton FL 33432';
          ...
          <Box bg="white" borderRadius="card" overflow="hidden" boxShadow="0 8px 32px rgba(60,50,40,0.05)" border="1px solid" borderColor="rgba(60,50,40,0.06)">
            <Flex direction={{ base: 'column', lg: 'row' }}>
              <Box w={{ base: '100%', lg: '46%' }} p={{ base: 8, md: 12 }}>
                <Text fontSize="xs" fontWeight={600} letterSpacing="2px" textTransform="uppercase" color="brand.champagne" mb={4}>Coming soon</Text>
                <Text as="h2" fontFamily="heading" fontSize={{ base: '2xl', md: '3xl' }} fontWeight={700} color="brand.slate" lineHeight={1.15} mb={6}>Our future home on Federal Highway</Text>
                <Text fontSize="md" color="brand.body" lineHeight={1.85} mb={8}>We are opening on South Federal Highway to serve Boca Raton and the surrounding Palm Beach County communities. Join the waitlist and we will reach out the moment doors open.</Text>
                ...
                <VStack align="flex-start" spacing={6} mb={9}>
                  ...
                  <Box>
                    <Text fontSize="xs" fontWeight={700} letterSpacing="1px" textTransform="uppercase" color="brand.bodyLight" mb={1}>Serving</Text>
                    <Text fontSize="md" color="brand.body" lineHeight={1.6}>Boca Raton and Palm Beach County</Text>
                  </Box>
                </VStack>
 
                <VStack align="stretch" spacing={3} w={{ base: '100%', sm: 'auto' }}>
                  <Button as={ChakraLink} href={primaryUrl} isExternal variant="primary" size="lg" rightIcon={<Icon as={HiArrowRight} />} _hover={{ textDecoration: 'none' }}>See the location</Button>
