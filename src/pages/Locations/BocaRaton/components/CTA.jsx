// src/pages/Locations/BocaRaton/components/CTA.jsx
import {
  Box,
  Flex,
  VStack,
    ...
    <Box py={{ base: 'sectionMobile', md: '120px' }} bg="white" ref={ref}>
      <Box maxW="98%" mx="auto" px={{ base: 6, md: 4 }}>
        <MotionBox initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} maxW={{ base: '100%', lg: '70%' }} mx="auto">
          <Box position="relative" borderRadius="32px" overflow="hidden">
            <Box position="absolute" top={0} left={0} right={0} bottom={0} zIndex={0}>
              <picture>
                ...
                <img src="/sections/cta-inner-banner.webp" alt="" aria-hidden="true" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
              </picture>
            </Box>
            ...
            <Box position="relative" zIndex={2} py={{ base: 12, md: 16 }} px={{ base: 8, md: 16 }}>
              <Flex direction={{ base: 'column', lg: 'row' }} alignItems={{ base: 'stretch', lg: 'center' }} justifyContent="space-between" gap={{ base: 8, lg: 12 }}>
                <Box flex={1}>
                  <Text fontSize="xs" fontWeight={600} letterSpacing="2px" textTransform="uppercase" color="brand.champagne" mb={4}>Be first in line</Text>
                  <Text as="h2" fontFamily="heading" fontSize={{ base: '2xl', md: '3xl', lg: '4xl' }} fontWeight={700} color="brand.slate" lineHeight={1.12} mb={3}>Interested in our Boca Raton location?</Text>
                ...
                <VStack spacing={3} align={{ base: 'stretch', lg: 'stretch' }} w={{ base: '100%', lg: 'auto' }} flexShrink={0}>
                  ...
                  <ChakraLink href="tel:5619333333" fontSize="md" color="brand.bodyLight" _hover={{ color: 'brand.champagne' }} transition="color 0.2s ease" textAlign="center" pt={1}>or call 561-933-3333</ChakraLink>
                </VStack>
              </Flex>
            </Box>
          </Box>
