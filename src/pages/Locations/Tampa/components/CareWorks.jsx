// src/pages/Locations/Tampa/components/CareWorks.jsx
import {
  Box,
  Flex,
  Text
...
var CONTENT = {
  ...
  heading: 'Healthcare on your schedule',
  body: 'The office is always open to you and your physician comes to you when you need it. All on one simple membership with no copays and no claims to chase.',
  reviews: [
    { quote: 'I texted Dr. Shapiro on a Sunday and had an answer in minutes. After years of waiting rooms, this feels like a different world.', name: 'Michael R.', since: 'Member since 2023' },
    { quote: 'No rushing, no runaround. They know me, my history, my family. Worth every penny and then some.', name: 'Sarah K.', since: 'Member since 2024' },
    { quote: 'When I was too sick to leave the house, my doctor came to me. I did not know healthcare could still work like this.', name: 'David T.', since: 'Member since 2024' }
  ]
};
