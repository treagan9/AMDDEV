// src/pages/Locations/StPete/components/CTA.jsx
import {
  Box,
  Flex,
  VStack,
            ...
            <Box position="relative" zIndex={2} py={{ base: 12, md: 16 }} px={{ base: 8, md: 16 }}>
              <Flex direction={{ base: 'column', lg: 'row' }} alignItems={{ base: 'stretch', lg: 'center' }} justifyContent="space-between" gap={{ base: 8, lg: 12 }}>
                <Box flex={1}>
                  ...
                  <Text as="h2" fontFamily="heading" fontSize={{ base: '2xl', md: '3xl', lg: '4xl' }} fontWeight={700} color="brand.slate" lineHeight={1.12} mb={3}>Ready to join our St. Petersburg practice?</Text>
