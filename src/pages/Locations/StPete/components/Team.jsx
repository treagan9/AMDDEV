// src/pages/Locations/StPete/components/Team.jsx
import {
  Box,
  Flex,
  SimpleGrid,
      ...
      <Box maxW="98%" mx="auto" px={{ base: 6, md: 4 }}>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={{ base: 12, md: 10 }} maxW="900px" mx="auto" mb={{ base: 14, md: 18 }}>
          {PHYSICIANS.map(function (doc, i) {
            return (
              <MotionBox key={doc.name} initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.2 + i * 0.12 }} textAlign="center">
