...
var HERO = {
  label: 'Our approach',
  heading: "Your doctor's cell number.",
  headingAccent: 'Yes, really.',
  body: 'Healthcare built around access, time and a physician who actually knows your name.',
  cta: 'Schedule a consultation',
  ctaLink: '/contact/',
  secondaryCta: 'What to expect',
  secondaryLink: '/new-patients/'
};
    ...
    <Box as="section">
      ...
      <Box display={{ base: 'none', md: 'block' }} position="relative" minH={{ md: '92vh', lg: '100vh' }} overflow="hidden">
        <Box position="absolute" top={0} left={0} right={0} bottom={0} zIndex={0}>
          <picture>
            ...
            <img src="/home/your-doctors-cell-hero-desktop.webp" alt="AnswersMD direct physician access by phone" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
          </picture>
        </Box>

        <Box position="absolute" top={0} left={0} right={0} bottom={0} zIndex={1} bg="linear-gradient(to right, rgba(250,250,247,0.96) 0%, rgba(250,250,247,0.9) 34%, rgba(250,250,247,0.5) 56%, transparent 74%)" />
        ...
        <MotionBox initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }} position="relative" zIndex={2} minH={{ md: '92vh', lg: '100vh' }} maxW="70%" mx="auto" px={4} display="flex" alignItems="center">
          <VStack spacing={7} align="flex-start" maxW={{ md: '580px', lg: '640px' }} position="relative">
            <Box position="absolute" top="-8%" left="-6%" w="116%" h="120%" bg="radial-gradient(ellipse 70% 60% at 32% 50%, rgba(250,250,247,0.84) 0%, rgba(250,250,247,0.55) 45%, transparent 72%)" zIndex={-1} pointerEvents="none" sx={{ filter: 'blur(12px)' }} />
      ...
      <Box display={{ base: 'block', md: 'none' }} bg="brand.ivory">
        <MotionBox initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          {/* Full-bleed image with bottom fade */}
          <Box position="relative" overflow="hidden">
            <Box sx={{ aspectRatio: '3 / 4' }}>
              <img src="/home/your-doctors-cell-hero-mobile.webp" alt="AnswersMD direct physician access" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top' }} />
            </Box>
