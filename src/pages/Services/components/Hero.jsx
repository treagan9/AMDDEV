  ...
  return (
    ...
    >
      ...
      <Box
        ...
        right={0}
        bottom={0}
        bg="linear-gradient(to bottom, rgba(250,250,247,0.92) 0%, rgba(250,250,247,0.86) 38%, rgba(250,250,247,0.4) 60%, transparent 80%)"
        zIndex={1}
      />
      ...
      <Box
        ...
        right={0}
        bottom={0}
        bg="linear-gradient(to right, rgba(250,250,247,0.96) 0%, rgba(250,250,247,0.9) 34%, rgba(250,250,247,0.5) 56%, transparent 74%)"
        zIndex={1}
      />
      ...
      >
        <VStack spacing={7} align={{ base: 'center', md: 'flex-start' }} maxW={{ md: '620px', lg: '680px' }} position="relative">
          <Box
            ...
            w="116%"
            h="120%"
            bg="radial-gradient(ellipse 70% 60% at 32% 50%, rgba(250,250,247,0.84) 0%, rgba(250,250,247,0.55) 45%, transparent 72%)"
            zIndex={-1}
            pointerEvents="none"
            sx={{ filter: 'blur(12px)' }}
          />
          ...
          <MotionBox initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.25 }}>
            <Text as="h1" fontFamily="heading" fontSize={{ base: '4xl', md: '5xl', lg: '6xl' }} fontWeight={700} color="brand.slate" lineHeight={1.05}>Your doctor's cell number.</Text>
            <Text fontFamily="heading" fontSize={{ base: '4xl', md: '5xl', lg: '6xl' }} fontWeight={700} color="brand.champagne" lineHeight={1.05}>Yes, really.</Text>
          </MotionBox>
