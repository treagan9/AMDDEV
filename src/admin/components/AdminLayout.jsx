...
function CalendarNavIcon({ active }) { return <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#2D2D2D' : '#9A9590'} strokeWidth={active ? 2.2 : 1.8} strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>; }
...
var MOBILE_NAV = [
  ...
  { path: '/answersmd-admin/calendar/', icon: CalendarNavIcon, match: 'calendar' },
  { path: '/answersmd-admin/patients/', icon: PatientsIcon, match: 'patients' },
  { path: '/answersmd-admin/marketing/', icon: EmailIcon, match: 'marketing' },
