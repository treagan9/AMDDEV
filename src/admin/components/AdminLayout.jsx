  ...
  return (
    <Box className="admin-root" display="flex" minH="100vh" bg="#FAFAF7" sx={{
      ...
      <Flex flex={1} ml={{ base: 0, lg: '260px' }} direction="column" minH="100vh">
        ...
        <Box flex={1} px={{ base: 5, md: 10 }} py={{ base: 5, md: 8 }} maxW="1200px">
          <Outlet />
        </Box>
        ...
        <Box position="fixed" bottom={5} right={5} color="#D5D0C8" opacity={0.5} _hover={{ opacity: 1, color: '#C4A265' }} transition="all 0.3s ease" cursor="default" zIndex={50}><PulseIcon /></Box>
      </Flex>
