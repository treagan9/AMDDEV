...
echo ""
echo "  AnswersMD Dev - Hero with background images"
echo "  =============================================="
echo ""
...
echo "  -> src/pages/Home/components/Hero.jsx"
cat > "src/pages/Home/components/Hero.jsx" << 'AMD_EOF_01'
...
echo ""
echo "  Done. Hero now has responsive background images."
echo "    Desktop: /home/hero-desktop.png"
echo "    Tablet: /home/hero-tablet.png"
echo "    Mobile: /home/hero-mobile.png"
echo "    + subtle top gradient for nav readability"
echo "    + light ivory overlay for text contrast"
echo "    + bottom gradient fade into next section"
echo ""
echo "  Run: yarn dev"
echo ""